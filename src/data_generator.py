...
def generate_dummy_dataset(samples=DATASET_SAMPLES, features=N_FEATURES, 
    ...
    """
    logger.info(f"Generating dummy dataset with {samples} samples and {features} features")
